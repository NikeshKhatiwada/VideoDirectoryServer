    ...
    public partial class M12 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_Transcript_Videos_VideoId",
                table: "Transcript");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChannelReports_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelReports_Users_ReporterUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoReports_Users_ReporterUserId",
                        column: x => x.ReporterUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoView_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelReports_ChannelId",
                table: "ChannelReports",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelReports_ReporterUserId",
                table: "ChannelReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoReports_ReporterUserId",
                table: "VideoReports",
                column: "ReporterUserId");
